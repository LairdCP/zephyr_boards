...
Laird Connectivity Sentrius BT520 Sensor
########################################

Overview
********

The Sentrius™ BT520 Sensor is a battery powered, Bluetooth v5 Long Range integrated sensor that uses a Nordic Semiconductor nRF52840 ARM Cortex-M4F CPU.
...
.. figure:: img/bt520.jpg
     :width: 250px
     :align: center
     :alt: Sentrius BT520 Sensor, front view

     Sentrius BT520 Sensor, front view

.. figure:: img/bt520_back.jpg
     :width: 250px
     :align: center
     :alt: Sentrius BT520 Sensor, rear view

     Sentrius BT520 Sensor, rear view

More information about the board can be found at the
`Sentrius BT520 website`_.
...
The BT520 Sensor supports the following
hardware features:
...
Two LEDs are visible through the BT520 housing lid.
...
The BT520 housing lid also acts as a push button.
...
The BT520 incorporates a Honeywell SM351LT magnetoresistive sensor. Refer to the `Honeywell SM351LT datasheet`_ for further details.
...
The BT520 incorporates an I2C ST Microelectronics LIS2DH accelerometer. Refer to the `ST Microelectronics LIS2DH datasheet`_ for further details.
...
The BT520 incorporates an I2C Silabs SI7055 temperature sensor. Refer to the `Silabs 7055 datasheet`_ for further details.
...
Applications for the ``bt520`` board configuration can be built, flashed, and
debugged in the usual way. See :ref:`build_an_application` and
:ref:`application_run` for more details on building and running.

The BT520 features a TagConnect 10 way socket for connection of a
...
To connect the BT520 board for programming or debugging using the USB-SWD programming
...
connect the BT520 to the board using the Tag-Connect cable via J3:

.. figure:: img/bt520_prog.png
     :width: 630px
     :align: center
     :alt: Sentrius BT520 Sensor connected to programming board

     Sentrius BT520 Sensor connected to programming board
...
NOTE: On the BT520, the UART lines are at TTL levels and must be passed through
...
to the BT520 acting as a USB CDC port, on Linux and Windows 10 this driver should be
...
Replace :code:`<tty_device>` with the port where the bt520 can be found. For example, under Linux, :code:`/dev/ttyACM0`.
...
The ``bt520`` board does not have an on-board J-Link debug IC
...
Testing Bluetooth on the BT520
***********************************
Many of the Bluetooth examples will work on the BT520.
Try them out:
...
Testing the LEDs and buttons on the BT520
*****************************************
...
:zephyr_file:`boards/arm/bt520/bt520.dts`.
...
.. _Sentrius BT520 website: https://www.lairdconnect.com/iot-devices/iot-sensors/bt520-bluetooth-5-long-range-ip67-multi-sensor
